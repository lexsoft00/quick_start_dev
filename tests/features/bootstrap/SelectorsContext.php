...
class SelectorsContext extends RawDrupalContext implements SnippetAcceptingContext {
  ...
  /**
   * #drupalcoders : Move the focus to selected field input element.
   *
  ...
  /**
   * #drupalcoders : Select part of the text in selected field input element.
   *
  ...
  /**
   * #drupalcoders : Select a part text in selected field input element.
   *
