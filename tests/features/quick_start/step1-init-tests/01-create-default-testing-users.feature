...
# test_super_admin: { email: 'super.admin.test@drupalcoders.com', password: 'LetMe.in1234' }
  ...
  Scenario: Create the test_authenticated user.
     ...
     When I fill in "authenticated.test@drupalcoders.com" for "Email address"
  ...
  Scenario: Create the test_editor user.
     When I go to "/admin/people/create"
      And I wait
     Then I should see "Add user"
     When I fill in "editor.test@drupalcoders.com" for "Email address"
  ...
  Scenario: Create the test_content_admin user.
     When I go to "/admin/people/create"
      And I wait
     Then I should see "Add user"
     When I fill in "content.admin.test@drupalcoders.com" for "Email address"
  ...
  Scenario: Create the test_site_admin user.
     When I go to "/admin/people/create"
      And I wait
     Then I should see "Add user"
     When I fill in "site.admin.test@drupalcoders.com" for "Email address"
  ...
  Scenario: Create the test_super_admin user.
     When I go to "/admin/people/create"
      And I wait
     Then I should see "Add user"
     When I fill in "super.admin.test@drupalcoders.com" for "Email address"
