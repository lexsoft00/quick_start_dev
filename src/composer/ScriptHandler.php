...
/**
 * QuickStart Composer Script Handler.
 */
class ScriptHandler {
  ...
  public static function postDrupalScaffoldProcedure(Event $event) {
    ...
    if ($fs->exists($drupal_root . '/profiles/quick_start/src/assets/development.services.yml')) {
      // Alter development.services.yml to have QuickStart's Local development
      // services.
      copy($drupal_root . '/profiles/quick_start/src/assets/development.services.yml', $drupal_root . '/sites/development.services.yml');
    }
  }
