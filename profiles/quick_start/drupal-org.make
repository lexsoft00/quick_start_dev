...
libraries[autogrow][download][url] = "http://download.ckeditor.com/autogrow/releases/autogrow_4.7.3.zip"
libraries[autogrow][destination] = "libraries"
libraries[colordialog][download][type] = get
libraries[colordialog][download][url] = "http://download.ckeditor.com/colordialog/releases/colordialog_4.7.3.zip"
libraries[colordialog][destination] = "libraries"
libraries[glyphicons][download][type] = get
libraries[glyphicons][download][url] = "http://download.ckeditor.com/glyphicons/releases/glyphicons_2.2.zip"
